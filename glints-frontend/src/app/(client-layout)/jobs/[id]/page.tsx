...
const JobInfo = async (props: any) => {
  ...
  return res?.data == null ? (
    <Result
      status="404"
      title="404"
      subTitle="Công việc này không tồn tại hoặc đã bị xóa!"
      extra={
        ...
        <div className={cx("content")}>
              ...
              <div className={cx("job-time")}>
                ...
                <Tag color="#f2f4f5">
                  <span className={cx("tag-title")}>
                    ...
                    Hạn nộp hồ sơ{": "}
                    {dayjs(res.data?.endDate).format("DD/MM/YYYY")}
                  </span>
                </Tag>
              </div>
          ...
          <div className={cx("detail-right")}>
            <div className={cx("company-detail")}>
              <div className={cx("company-logo")}>
                ...
                <Link
                  ...
                  href={`/companies/${res?.data?.company?._id}`}
                >
            ...
            <div className={cx("company-link")}>
              <Link href={`/companies/${res?.data?.company?._id}`}>
                Xem trang công ty
